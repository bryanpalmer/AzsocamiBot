...
class Help(commands.Cog):
    ...
    async def help(self, ctx, *input):
        ...
        version = "ver 1"  # enter version of your code

        # setting owner name - if you don't wanna be mentioned remove line 49-60 and adjust help text (line 88)
        owner = 136592889802260480  # ENTER YOU DISCORD-ID
        owner_name = "Aaryn#5030"  # ENTER YOUR USERNAME#1234
        ...
        if not input:
            ...
            emb.add_field(
                name="About",
                value=f"The Bots is developed by Chriѕ#0001, based on discord.py.\n\
